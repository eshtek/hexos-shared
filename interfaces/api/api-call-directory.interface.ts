...
import {
    ...
    CreateApiKeyRequest,
    UpdateApiKeyRequest,
} from '@shared/interfaces/api-key.interface';
import { UpgradeSummary } from '@shared/interfaces/application.interface';
import {
    AuditConfig,
    AuditEntry,
    AuditQueryParams,
} from '@shared/interfaces/audit/audit.interface';
...
import { ChartReleaseEvent } from '@shared/interfaces/chart-release-event.interface';
import {
    ChartRelease,
...
import {
    ...
    CloudBackupSnapshot,
    CloudBackupUpdate,
} from '@shared/interfaces/cloud-backup.interface';
import {
...
} from '@shared/interfaces/cloudsync-provider.interface';
import {
    ContainerConfig,
    ContainerConfigUpdate,
} from '@shared/interfaces/container-config.interface';
import {
    ContainerImage,
...
} from '@shared/interfaces/core-download.interface';
import {
...
import {
    ...
    SetDatasetQuota,
} from '@shared/interfaces/dataset-quota.interface';
import {
    Dataset,
    DatasetCreate,
    DatasetDetails,
...
import { FailoverConfig, FailoverUpdate } from '@shared/interfaces/failover.interface';
...
import { Ipmi, IpmiChassis, IpmiQueryParams, IpmiUpdate } from '@shared/interfaces/ipmi.interface';
import {
    IscsiGlobalConfig,
...
import {
    ...
    NfsConfig,
    NfsConfigUpdate,
} from '@shared/interfaces/nfs-config.interface';
import {
    Nfs3Session,
    Nfs4Session,
    NfsShare,
...
import { Pool, PoolInstance } from '@shared/interfaces/pool.interface';
...
import { ReplicationCreate, ReplicationTask } from '@shared/interfaces/replication-task.interface';
import {
...
import { ReportingData, ReportingQueryParams } from '@shared/interfaces/reporting.interface';
...
} from '@shared/interfaces/system-config.interface';
...
import {
    ...
    UserTwoFactorConfig,
} from '@shared/interfaces/two-factor-config.interface';
...
export type ApiCallResponseType<T extends ApiCallMethod> =
    ApiCallDirectory[T]['response'] extends (infer U)[] ? U : never;
