import { SetAcl } from '@shared/interfaces/acl.interface';
import { ActiveDirectoryConfig, LeaveActiveDirectory } from '@shared/interfaces/active-directory-config.interface';
import { ActiveDirectoryUpdate } from '@shared/interfaces/active-directory.interface';
import { AuditEntry } from '@shared/interfaces/audit/audit.interface';
import { Catalog, CatalogCreate } from '@shared/interfaces/catalog.interface';
import { Certificate, CertificateCreate, CertificateUpdate } from '@shared/interfaces/certificate.interface';
import {
  ChartRollbackParams,
...
import { CloudSyncTaskUpdate } from '@shared/interfaces/cloud-sync-task.interface';
import { ConfigResetParams } from '@shared/interfaces/config-reset-params.interface';
import { PullContainerImageParams, PullContainerImageResponse } from '@shared/interfaces/container-image.interface';
import { CoreBulkQuery, CoreBulkResponse } from '@shared/interfaces/core-bulk.interface';
import { DatasetChangeKeyParams } from '@shared/interfaces/dataset-change-key.interface';
import {
  DatasetEncryptionSummary,
  DatasetEncryptionSummaryQueryParams,
} from '@shared/interfaces/dataset-encryption-summary.interface';
import { DatasetLockParams, DatasetUnlockParams, DatasetUnlockResult } from '@shared/interfaces/dataset-lock.interface';
import { ExportParams } from '@shared/interfaces/export-params.interface';
import { FailoverUpgradeParams } from '@shared/interfaces/failover.interface';
import { FilesystemPutParams, FilesystemSetPermParams } from '@shared/interfaces/filesystem-stat.interface';
import { IpmiEvent } from '@shared/interfaces/ipmi.interface';
import { Job } from '@shared/interfaces/job.interface';
import { KmipConfig, KmipConfigUpdate } from '@shared/interfaces/kmip-config.interface';
import { KubernetesConfig, KubernetesConfigUpdate } from '@shared/interfaces/kubernetes-config.interface';
import { LdapConfig, LdapConfigUpdate } from '@shared/interfaces/ldap-config.interface';
import { MailConfigUpdate, SendMailParams } from '@shared/interfaces/mail-config.interface';
import { PoolExportParams } from '@shared/interfaces/pool-export.interface';
import { PoolFindResult, PoolImportParams } from '@shared/interfaces/pool-import.interface';
import { PoolRemoveParams } from '@shared/interfaces/pool-remove.interface';
import { PoolScrubTaskParams } from '@shared/interfaces/pool-scrub.interface';
import {
  CreatePool,
  Pool,
  PoolAttachParams,
...
import { DiskWipeParams } from '@shared/interfaces/storage.interface';
import { SystemDatasetConfig, SystemDatasetUpdate } from '@shared/interfaces/system-dataset-config.interface';
import { SystemSecurityConfig } from '@shared/interfaces/system-security-config.interface';
import { UpdateParams } from '@shared/interfaces/system-update.interface';
import { Tunable, TunableCreate, TunableUpdate } from '@shared/interfaces/tunable.interface';
import { VmStopParams } from '@shared/interfaces/virtual-machine.interface';
import { AttachTicketParams, CreateNewTicket, NewTicketResponse } from '@shared/modules/feedback/interfaces/file-ticket.interface';
