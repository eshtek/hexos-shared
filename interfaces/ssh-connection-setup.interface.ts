import { SshConnectionsSetupMethod } from '@shared/enums/ssh-connections-setup-method.enum';
import { SshCredentials } from '@shared/interfaces/ssh-credentials.interface';
