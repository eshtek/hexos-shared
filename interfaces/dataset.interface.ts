import { AclMode } from '@shared/enums/acl-type.enum';
import {
  DatasetAclType,
  ...
  DatasetXattr,
} from '@shared/enums/dataset.enum';
import { DeduplicationSetting } from '@shared/enums/deduplication-setting.enum';
import { EncryptionKeyFormat } from '@shared/enums/encryption-key-format.enum';
import { IscsiExtentType } from '@shared/enums/iscsi.enum';
import { OnOff } from '@shared/enums/on-off.enum';
import { WithInherit } from '@shared/enums/with-inherit.enum';
import { ZfsProperty } from '@shared/interfaces/zfs-property.interface';
