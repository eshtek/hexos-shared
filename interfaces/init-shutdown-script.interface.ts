import { InitShutdownScriptType } from '@shared/enums/init-shutdown-script-type.enum';
import { InitShutdownScriptWhen } from '@shared/enums/init-shutdown-script-when.enum';
