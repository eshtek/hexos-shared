import type { AppState } from '../enums/app-state.enum';
import type { ChartSchemaType } from '../enums/chart-schema-type.enum';
import type { CodeEditorLanguage } from '../enums/code-editor-language.enum';
import type { AppMaintainer } from './available-app.interface';
import type { ChartMetadata } from './catalog.interface';
import type { HierarchicalObjectMap } from './hierarhical-object-map.interface';
import type { QueryParams } from './query-api.interface';
...
export type AppQueryParams = QueryParams<
    App,
    {
        extra?: {
            /**
...
export type AppUpgradeParams = [name: string, params?: AppUpgrade];
...
export type AppStartQueryParams = [name: string];
