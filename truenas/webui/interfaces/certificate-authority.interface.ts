import type { CaCreateType } from '../enums/ca-create-type.enum';
...
import type { EcCurve } from '../enums/ec-curve.enum';
import type { ExtendedKeyUsageFlag } from '../enums/extended-key-usage-flag.enum';
