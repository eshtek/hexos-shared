...
export const helptextRsyncForm = {
    rsync_path_tooltip: T(
        'Browse to the path to be copied. Linux\
 ...
 of the rsync server or to use an SSH configuration for the rsync task.',
    ...
    rsync_ssh_connect_mode_tooltip: T(
        "Choose to connect using either SSH private key stored \
  in user's home directory or SSH connection from the keychain",
    ),
    rsync_ssh_credentials_tooltip: T(
        'Select an existing SSH connection to a remote system or \
