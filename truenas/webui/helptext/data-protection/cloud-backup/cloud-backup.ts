...
export const helptextCloudBackup = {
    ...
    enabled_tooltip: T(
        'Enable this TrueCloud Backup Task. Unset to disable this TrueCloud\
 Backup Task without deleting it.',
    ),

    bucket_input_placeholder: T('New Bucket Name'),
    bucket_input_tooltip: T(
        'Enter the name of the new bucket. Only lowercase letters, numbers, and hyphens are allowed.',
    ),
 ...
 for more details about the <code>--exclude</code> option.',
    ...
    schedule_tooltip: T(
        'Select a schedule preset or choose <i>Custom</i> to setup custom schedule.',
    ),
};
