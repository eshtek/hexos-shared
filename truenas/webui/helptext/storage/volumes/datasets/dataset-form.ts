...
export const helptextDatasetForm = {
 ...
 writes to complete.',
    ...
    dataset_form_sync_disabled_warning: T(
        'TrueNAS recommends that the sync setting always \
 ...
 result in significant performance gains.',
    ...
    dataset_form_dataset_preset_tooltip: T(
 ...
 space for this dataset.',
    ...
    acl_type_change_warning: T(
        'Changes to ACL type affect how on-disk ZFS ACL is \
 ...
 a one-way process. <b>Deduplicated data cannot be undeduplicated!</b>.',
    ...
    deduplicationWarning:
        T(`The default "Checksum" value for datasets with deduplication used to be SHA256.
 ...
 or <i>Invisible</i> on this dataset.',
    ...
    dataset_form_snapdev_tooltip: T(
 ...
 See <a href="https://zfsonlinux.org/manpages/0.7.13/man8/zpool.8.html" target="_blank">zpool(8)</a> for more details on the special allocation',
    ...
    dataset_form_preset: {
        ...
        apps: T(
            'Dataset for use by an application. If you plan to deploy container applications,\
 the system automatically creates the ix-applications dataset but this is not used for application data storage.',
        ),
        smb_description: T(
            'By clicking the share creation checkbox below, a new share will be created on form submission with the default\
