...
export const helptextAcl = {
 ...
 specific type of permission for finer control.',
    ...
    dataset_acl_user_tooltip: T(
        'User account to which this ACL entry\
 applies.',
    ),
...
are submitted only when this box is set.',
 ...
 configured to match general permissions situations.',
        ...
        message: T(
            'The chosen preset ACL will <strong>REPLACE</strong> the ACL currently displayed in the form \
