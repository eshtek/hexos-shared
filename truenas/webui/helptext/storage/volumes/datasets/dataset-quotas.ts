...
export const helpTextQuotas = {
    ...
    users: {
        ...
        tooltip: T(
            'You can search both for local users as well as users from Active Directory.\
Press ENTER to separate entries.',
 ...
 Entering <code>0</code> (zero) allows unlimited objects.',
        ...
        remove_invalid_quotas: {
            message: T(
                'This action will set all dataset quotas for the removed or invalid users to 0,\
 virtually removing any dataset quota entires for such users. Are you sure you want to proceed?',
    ...
    groups: {
        ...
        tooltip: T(
            'You can search both for local groups as well as groups from Active Directory.\
 Press ENTER to separate entries.',
        ),
        data_quota: {
 ...
 Entering <code>0</code> (zero) allows unlimited objects.',
        ...
        remove_invalid_quotas: {
            message: T(
                'This action will set all dataset quotas for the removed or invalid groups to 0,\
