...
export const helptextSystemSupport = {
 ...
 TrueNAS Forums</a> - Find answers from other users in the forums.',
    ...
    licensing: T(
        '<a href="https://www.ixsystems.com/support/truenas-arrays/" target="_blank">\
 TrueNAS Licensing</a> - Learn more about enterprise-grade support.',
    ...
    debugSizeLimitWarning: T(
        'The ticket was created successfully (see link below), but the debug file\
