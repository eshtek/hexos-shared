...
export const helptextSystemAdvanced = {
 ...
 hardware issues.',
  ...
  reboot.',
    ...
    max_parallel_replication_tasks_tooltip: T(
        'Maximum number of replication tasks being executed \
simultaneously.',
    ),
 ...
 SEDs',
    ...
    reservation_tooltip: T(
        'Size in GiB of refreservation to set on ZFS dataset \
 ...
 the TLS protocol connection to the remote system log server.',
    ...
    allowed_ip_addresses: {
        tooltip: T(
            'You may enter a specific IP address (e.g., 192.168.1.1) for individual access, or use an \
