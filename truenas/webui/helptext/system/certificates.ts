...
export const helptextSystemCertificates = {
    add: {
        ...
        cert_create_type: {
            tooltip: T(
                '<i>Internal Certificates</i> use system-managed CAs for certificate issuance. \
 <i>Import Certificate</i> lets you import an existing certificate onto the system.',
        ...
        csr_create_type: {
            placeholder: T('Type'),
            tooltip: T(
                '<i>Certificate Signing Requests</i> control when an external CA will issue (sign) the certificate. Typically used with ACME or other CAs that most popular browsers trust by default \
...
matches your certificate usage scenario.',
        ...
        csrlist: {
            tooltip: T('Select an existing CSR.'),
        },
 ...
 a key at least 1024 bits long.',
        ...
        basic_constraints: {
            config: {
                tooltip: T(
                    'Specify whether to use the certificate for a Certificate Authority \
          ...
          CA and enable Critical Extension.',
            ...
            enabled: {
                tooltip: T(
                    "Activate the Basic Constraints extension to identify whether \
...
certificate still approved.',
        ...
        authority_key_identifier: {
            config: {
                tooltip: T(
                    'Specify whether the issued certificate should include Authority Key Identifier information,\
...
certificate still approved.',
        ...
        key_usage: {
            config: {
                tooltip: T(
                    "Specify this certificate's valid Key Usages. Web certificates \
