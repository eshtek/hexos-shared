...
export const helptextVmWizard = {
 ...
 connection. Requires <i>UEFI</i> booting.',
    ...
    display_bind_tooltip: T(
        'Select an IP address to use for remote SPICE sessions.\
 ...
 restrictions on the number of CPUs.',
    ...
    cpuset: {
        tooltip: T(
            'Specify the logical cores that VM is allowed to use. \
...
E.g. to assign cores: 0,1,2,5,9,10,11 you can write: 1-2,5,9-11',
    ...
    nodeset: {
        tooltip: T(
            'Node set allows setting NUMA nodes for multi NUMA processors when CPU set was defined. \
...
E.g. if cpus 0,1 belong to NUMA node 0 then setting nodeset to 0 will improve memory locality',
    ...
    pin_vcpus: {
        tooltip: T(
            'When number of vcpus is equal to number of cpus in CPU set vcpus can be automatically pinned into CPU set. \
...
This will improve CPU cache locality and can reduce possible stutter in GPU passthrough VMs.',
 ...
 timeout has expired.',
    ...
    hyperv_enlightenments_tooltip: T(
        "KVM implements Hyper-V Enlightenments \
