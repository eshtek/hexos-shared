...
export const helptextInterfacesForm = {
 ...
 be configured for DHCP.',
    ...
    enable_learning_tooltip: T(
        'Toggle off to defer interface learning until runtime, preventing premature state transitions and potential issues during system startup.',
    ),
 ...
 interfaces have been manually configured.',
    ...
    lagg_interfaces_failover_tooltip: T(
        'Select the interfaces to use in the aggregation.<br>\
