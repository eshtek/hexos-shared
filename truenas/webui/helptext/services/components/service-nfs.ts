...
export const helptextServiceNfs = {
 ...
 Static IPs need to be configured on the interface to appear on the list.',
    ...
    nfs_srv_servers_tooltip: T(
        'Enter an optimal number of threads used\
 by the kernel NFS server.',
    ),

    nfs_srv_servers_auto_tooltip: T(
        'Automatically sets number of threads used\
 by the kernel NFS server.',
    ),
 ...
 target="_blank">rpc.lockd(8)</a>.',
    ...
    userd_manage_gids: T(
        'Enable server-side management of group memberships. \
