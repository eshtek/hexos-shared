...
export const helptextServiceSmart = {
 ...
 tests are configured to run.',
    ...
    smart_powermode_tooltip: T(
        'Tests are only performed when <i>Never</i> \
is selected.',
    ),
    smart_difference_tooltip: T(
        'Enter a number of degrees in Celsius. S.M.A.R.T. reports if\
 the temperature of a drive has changed by N degrees\
 Celsius since the last report.',
    ),
    smart_informational_tooltip: T(
        'Enter a threshold temperature in Celsius. S.M.A.R.T. will\
