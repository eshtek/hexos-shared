...
export const helptextApps = {
    ...
    kubForm: {
        ...
        validateHostPath: {
            ...
            warning:
                T(`Disabling host path validation may result in undefined behavior from TrueNAS system
 ...
 Hyphen is allowed in the middle e.g abc123, abc, abcd-1232',
    ...
    thirdPartyRepoWarning: {
        ...
        title: T('Warning'),
        message:
            T(`iXsystems does not audit or otherwise validate the contents of third-party applications catalogs. \
    ...
    dockerHubRateLimit: {
        message: T(
            "User limit to Docker Hub has almost/or has been reached. Installation process may get stalled as images wouldn't be pulled. Current limit would be renewed in {seconds}. Application can still be installed.",
        ),
    },
};
