...
export const helptextTopbar = {
    ...
    ha_disabled_reasons: {
        ...
        [FailoverDisabledReason.NoSystemReady]: T(
        ...
        [FailoverDisabledReason.LocalFipsRebootRequired]: T(
            'Reboot of this node is required for FIPS changes.',
        ),
        [FailoverDisabledReason.RemoteFipsRebootRequired]: T(
            'Reboot of the other node is required for FIPS changes.',
        ),
    },
