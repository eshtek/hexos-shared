import { PosixPermission } from '@shared/truenas/webui/enums/posix-acl.enum';
import type { UnixFilePermissions } from '@shared/truenas/webui/interfaces/posix-permissions.interface';
