export enum GlobalErrorCode {
    ...
    SERVER_UPDATE_ALREADY_IN_PROGRESS = 'An update is already in progress for this server',
    SERVER_UPDATE_NOT_AVAILABLE = 'No update is available for this server',
    SERVER_UPDATE_NOT_SUPPORTED = 'Updates are not supported on TrueNAS 25.10.0+',
    EMAIL_ACTION_INVALID_KEY = 'Invalid or expired link',
